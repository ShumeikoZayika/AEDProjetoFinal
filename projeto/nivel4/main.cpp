...
static bool handleCommand(Service& svc, const std::string& line) {
...
static void runDemo(Service& svc) {
    const char* script[] = {
        "stats",
        "nodes threat-actor",
        "node apt29",
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================================\n");
    printf("  Grafo de Conhecimento CTI - Nivel 4 (Acesso local / Servico)\n");
    printf("==============================================================\n");
    ...
    while (std::getline(std::cin, line)) {
        if (!handleCommand(svc, line)) break;
        printf("> ");
    }
    return 0;
}
